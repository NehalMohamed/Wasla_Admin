...
import { GetAllInvoices, ConfirmInvoice } from "../../slices/AccountingSlice";
            ...
            <Row>
              <Col md={6} xs={12}>
                ...
                <DatePicker
                  selected={date_from}
                  onChange={(date) =>
                    setDate_from(format(date, "dd-MM-yyyy hh:mm:ss"))
                  }
              ...
              <Col md={6} xs={12}>
                ...
                <DatePicker
                  selected={date_to}
                  onChange={(date) =>
                    setDate_to(format(date, "dd-MM-yyyy hh:mm:ss"))
                  }
                  className="date_picker"
                />
              </Col>
            ...
            {Invoices && Invoices.length > 0 ? (
              Invoices.filter((item) =>
                ...
                >
                  ...
                  <td>{mapStatusName(invoice.status)}</td>
